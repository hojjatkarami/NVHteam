function [M_v,C_v,K_v] = BodyParameters2(sus,M_e,x)
...
C_v(5:7,1:14) = ...
    ...
    [0 0 -1;0 R_2(3) -R_2(2);-R_2(3) 0 R_2(1)]*c_2*([eye(3) B_2']*[zeros(6,7) eye(6,6) zeros(6,1)]-[eye(3) Bb_2']*[zeros(2,14);[zeros(3,4) eye(3) zeros(3,7)];zeros(1,14)]) + ...
    [0 0 -1;0 R_3(3) -R_3(2);-R_3(3) 0 R_3(1)]*c_3*([eye(3) B_3']*[zeros(6,7) eye(6,6) zeros(6,1)]-[eye(3) Bb_3']*[zeros(2,14);[zeros(3,4) eye(3) zeros(3,7)];zeros(1,14)]) +...
    [0 0 -1;0 R_1(3) -R_1(2);-R_1(3) 0 R_1(1)]*(c_1*([eye(3) B_1']*[zeros(6,7) eye(6,6) zeros(6,1)]-[eye(3) Bb_1']*[zeros(2,14);[zeros(3,4) eye(3) zeros(3,7)];zeros(1,14)]) + ...
                                                A_1*[0;0;c_m_1]*([zeros(1,13) 1]-[0 0 1]*[eye(3) Bb_1']*[zeros(2,14);[zeros(3,4) eye(3) zeros(3,7)];zeros(1,14)])) ;

C_v(8:13,1:14) = ...
    [eye(3);B_1]*c_1*([eye(3) B_1']*[zeros(6,7) eye(6,6) zeros(6,1)]-[eye(3) Bb_1']*[zeros(2,14);[zeros(3,4) eye(3) zeros(3,7)];zeros(1,14)]) + ...
    [eye(3);B_2]*c_2*([eye(3) B_2']*[zeros(6,7) eye(6,6) zeros(6,1)]-[eye(3) Bb_2']*[zeros(2,14);[zeros(3,4) eye(3) zeros(3,7)];zeros(1,14)]) + ...
    [eye(3);B_3]*c_3*([eye(3) B_3']*[zeros(6,7) eye(6,6) zeros(6,1)]-[eye(3) Bb_3']*[zeros(2,14);[zeros(3,4) eye(3) zeros(3,7)];zeros(1,14)]);

C_v(14,1:14) = c_m_1*([zeros(1,13) 1]-[0 0 1]*[eye(3) Bb_1']*[zeros(2,14);[zeros(3,4) eye(3) zeros(3,7)];zeros(1,14)]);
...
K_v(5:7,1:14) = ...
    ...
    [0 0 -1;0 R_2(3) -R_2(2);-R_2(3) 0 R_2(1)]*k_2*([eye(3) B_2']*[zeros(6,7) eye(6,6) zeros(6,1)]-[eye(3) Bb_2']*[zeros(2,14);[zeros(3,4) eye(3) zeros(3,7)];zeros(1,14)]) + ...
    [0 0 -1;0 R_3(3) -R_3(2);-R_3(3) 0 R_3(1)]*k_3*([eye(3) B_3']*[zeros(6,7) eye(6,6) zeros(6,1)]-[eye(3) Bb_3']*[zeros(2,14);[zeros(3,4) eye(3) zeros(3,7)];zeros(1,14)]) +...
    [0 0 -1;0 R_1(3) -R_1(2);-R_1(3) 0 R_1(1)]*k_1*([eye(3) B_1']*[zeros(6,7) eye(6,6) zeros(6,1)]-[eye(3) Bb_1']*[zeros(2,14);[zeros(3,4) eye(3) zeros(3,7)];zeros(1,14)]) ;

K_v(8:13,1:14) = ...
    [eye(3);B_1]*(k_1*([eye(3) B_1']*[zeros(6,7) eye(6,6) zeros(6,1)]-[eye(3) Bb_1']*[zeros(2,14);[zeros(3,4) eye(3) zeros(3,7)];zeros(1,14)]) + ...
                  A_1*[0;0;k_m_1]*([0 0 1]*A_1'*[eye(3) B_1']*[zeros(6,7) eye(6,6) zeros(6,1)]-[zeros(1,13) 1])) + ...
    [eye(3);B_2]*k_2*([eye(3) B_2']*[zeros(6,7) eye(6,6) zeros(6,1)]-[eye(3) Bb_2']*[zeros(2,14);[zeros(3,4) eye(3) zeros(3,7)];zeros(1,14)]) + ...
    [eye(3);B_3]*k_3*([eye(3) B_3']*[zeros(6,7) eye(6,6) zeros(6,1)]-[eye(3) Bb_3']*[zeros(2,14);[zeros(3,4) eye(3) zeros(3,7)];zeros(1,14)]);
