...
e_TV = e;
lb_3 = x_opt1_f(1:38) - e_TV.*abs(x_opt1_f(1:38));
ub_3 = x_opt1_f(1:38) + e_TV.*abs(x_opt1_f(1:38));
lb_2(19:38) = lb(19:38);
ub_2(19:38) = ub(19:38);
...
e_TF = e;
lb_2 = x_opt3_f(1:38) - e_TF.*abs(x_opt3_f(1:38));
ub_2 = x_opt3_f(1:38) + e_TF.*abs(x_opt3_f(1:38));
lb_2(19:38) = lb(19:38);
ub_2(19:38) = ub(19:38);
