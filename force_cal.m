function [F_1, F_2, F_3] = force_cal(x, z,hyd)
...
for i = 1:length(z(:,1)) 
    F_1(i,:) = hyd * c_1*[eye(3) B_1']*z(i,8:13)' + A_1*(k_l_1-hyd*[0 0 0;0 0 0;0 0 k_m_1])*A_1'*[eye(3) B_1']*z(i,1:6)' + hyd*A_1*[0;0;c_m_1]*z(i,14);
