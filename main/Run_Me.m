...
lb_3(19:27) = lb(19:27);
ub_3(19:27) = ub(19:27);
FitnessFcn3 = @(x) TA1(x, eta, omega, Fhat, M, sus, 100, 1, Pen_Wt);
[x_opt3,~] = particleswarm(FitnessFcn3,27,lb_3,ub_3,options);
x_opt3 = x_opt3';
FitnessFcn33 = @(x) TA1(x, eta, omega, Fhat, M, sus, 1,0,0);
...
%% Results
% close all
% ForcePlot(t,F_1_opt3,F_2_opt3,F_3_opt3)
% AccPlot(t,x_opt3,eta,M,eng,sus,t_step)