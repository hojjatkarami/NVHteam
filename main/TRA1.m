...
C = max([100-KEF(best_index(1),1),100-KEF(best_index(2),2),100-KEF(best_index(3),3),100-KEF(best_index(4),4),100-KEF(best_index(5),5),100-KEF(best_index(6),6)]);
