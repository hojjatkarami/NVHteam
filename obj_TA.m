function F = obj_TA(x, MountSelector, OptTypeSelector, eta, w, f, M, sus, a, b, d)
r_1 = x(1:3);
r_2 = x(4:6);
r_3 = x(7:9);
R_1 = sus.E_cm + r_1;
...
A = MountSelector.*[abs((-w^2*([zeros(1,4) 1 zeros(1,8)]-[zeros(1,6) R_1(1) zeros(1,6)]+[zeros(1,5) R_1(2) zeros(1,7)])*q_hat)); ...
