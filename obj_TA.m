...
size(ComponentSelector)
size([((-w(i)^2*([zeros(1,4) 1 zeros(1,9)]-[zeros(1,6) R_1(1) zeros(1,7)]+[zeros(1,5) R_1(2) zeros(1,8)])*q_hat)) ...
        ,((-w(i)^2*([zeros(1,4) 1 zeros(1,9)]-[zeros(1,6) R_2(1) zeros(1,7)]+[zeros(1,5) R_2(2) zeros(1,8)])*q_hat))...
        ,((-w(i)^2*([zeros(1,4) 1 zeros(1,9)]-[zeros(1,6) R_3(1) zeros(1,7)]+[zeros(1,5) R_3(2) zeros(1,8)])*q_hat))])
[((-w(i)^2*([zeros(1,4) 1 zeros(1,9)]-[zeros(1,6) R_1(1) zeros(1,7)]+[zeros(1,5) R_1(2) zeros(1,8)])*q_hat)) ...
        ,((-w(i)^2*([zeros(1,4) 1 zeros(1,9)]-[zeros(1,6) R_2(1) zeros(1,7)]+[zeros(1,5) R_2(2) zeros(1,8)])*q_hat))...
        ,((-w(i)^2*([zeros(1,4) 1 zeros(1,9)]-[zeros(1,6) R_3(1) zeros(1,7)]+[zeros(1,5) R_3(2) zeros(1,8)])*q_hat))]
